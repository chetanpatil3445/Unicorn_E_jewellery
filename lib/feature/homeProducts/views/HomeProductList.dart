...
import '../controllers/homeProductsListController.dart';
...
class _HomeProductListState extends State<HomeProductList> {
  final homeProductsListController controller = Get.put(homeProductsListController());
  ...
  Widget _premiumMetalDropdown(homeProductsListController controller) {
    return Theme(

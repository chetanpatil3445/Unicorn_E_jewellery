...
//   static const Color goldColor = Color(0xFFC5A059); // Muted Gold for luxury
...
//         slivers: [
//           // Dynamic Banner with Soft Overlay
//           SliverToBoxAdapter(
//             child: Container(
//               height: 130, // More compact banner
...
//           ),
//
//           // Grid with Smaller, Elegant Cards
//           SliverPadding(
...
//                   crossAxisSpacing: 10,
//                   mainAxisSpacing: 10,
//                   childAspectRatio: 2.8 // Narrower for a list-like look
//               ),
//               delegate: SliverChildBuilderDelegate(
//                     (context, index) => _buildCompactTagCard(tags[index]),
...
//   }
//
//   Widget _buildCompactTagCard(String name) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,

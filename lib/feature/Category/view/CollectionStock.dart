...
import 'package:unicorn_e_jewellers/feature/Category/view/category_menu_page.dart';
import '../../../Routes/app_routes.dart';
import '../../products/model/product_model.dart';
import '../controller/Category_tag_controller.dart';

class CollectionStock extends StatefulWidget {
  @override
  State<CollectionStock> createState() => _CollectionStockState();
}

class _CollectionStockState extends State<CollectionStock> {
  ...
  Widget _premiumMetalDropdown(TagController controller) {
    return Theme(
          ...
          children: [
            ...
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                elevation: 5,
                shadowColor: deepBlack.withOpacity(0.3),
              ),
              onPressed: () {
                controller.clearFilters();
                Get.back(); // Ye user ko wapas Category/Collection selection page par le jayega
              },
              icon: const Icon(Icons.auto_awesome_mosaic_rounded, size: 18, color: goldAccent),
              label: Text(

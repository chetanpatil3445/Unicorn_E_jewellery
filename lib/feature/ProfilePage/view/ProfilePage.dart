        ...
        child: Column(
          children: [
            ...
            _buildMenuSection("MY ACTIVITY", [
              _luxuryItem(Icons.shopping_bag_outlined, "My Orders", "Track, cancel or return",
                  onTap: controller.openOrders),
              _luxuryItem(Icons.favorite_outline, "Wishlist", "Saved luxury pieces",
                  onTap: controller.openWishlist),
              _luxuryItem(Icons.star_outline, "My Reviews", "Your feedback"),
            ]),
